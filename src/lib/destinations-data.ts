...
export const travelTypes: TravelType[] = [
  ...
  },
  {
    title: "טיול קרוואנים",
    description:
      "מסלול קרוואן/RV נגיש: חניוני לילה נגישים, עצירות תכופות לשירותים וקצב נינוח למשפחה.",
    destinations: ["יוון", "איטליה", "גרמניה"],
  },
  {
    title: "טיול אופני ידיים",
    description:
      "מסלולי הנדבייק מותאמים: משטחים ישרים, שיפועים נוחים, נקודות מנוחה ושירותים נגישים בדרך.",
    destinations: ["הולנד", "אוסטריה", "ברצלונה"],
  },
];
